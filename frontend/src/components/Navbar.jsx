...
function Navbar() {
  ...
  return (
    ...
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-neutral-200 dark:text-black">
      <div className="navbar bg-base-400">
        ...
        <div className="navbar-end space-x-3">
          ...
          <div className="hidden  md:block ">
            {/* bg-transparent text-dark border-black */}
            <label className="input input-bordered dark:border-black flex items-center gap-2 dark:bg-neutral-200 dark:text-black ">
